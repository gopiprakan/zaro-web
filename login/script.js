...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    EN: {
      ...
      exampleHint: '<strong>Default Example:</strong> Username <code>user@zaroweb.in</code> &bull; Password <code>min 6 chars</code> &mdash; please manually type your username &amp; password.',
      emailLabel: 'Email or Username',
      emailPlaceholder: 'e.g. user@zaroweb.in or your_username',
    ...
    TA: {
      ...
      exampleHint: '<strong>மாதிரி வடிவம்:</strong> பயனர்பெயர் <code>user@zaroweb.in</code> &bull; கடவுச்சொல் <code>min 6 எழுத்துகள்</code> &mdash; உங்கள் விவரங்களை கீழே நேரடியாக டைப் செய்யவும்.',
      emailLabel: 'மின்னஞ்சல் அல்லது பயனர்பெயர்',
      emailPlaceholder: 'எ.கா: user@zaroweb.in அல்லது உங்கள்_பெயர்',
    ...
    HI: {
      ...
      exampleHint: '<strong>डिफ़ॉल्ट उदाहरण:</strong> यूज़रनेम <code>user@zaroweb.in</code> &bull; पासवर्ड <code>कम से कम 6 अक्षर</code> &mdash; कृपया अपने विवरण मैन्युअल रूप से टाइप करें।',
      emailLabel: 'ईमेल या यूज़रनेम',
      emailPlaceholder: 'उदा. user@zaroweb.in या यूज़रनेम',
    ...
    TE: {
      ...
      exampleHint: '<strong>డిఫాల్ట్ ఉదాహరణ:</strong> యూజర్‌నేమ్ <code>user@zaroweb.in</code> &bull; పాస్‌వర్డ్ <code>కనీసం 6 అక్షరాలు</code> &mdash; దయచేసి వివరాలను మాన్యువల్‌గా టైప్ చేయండి.',
      emailLabel: 'ఇమెయిల్ లేదా యూజర్‌నేమ్',
      emailPlaceholder: 'ఉదా: user@zaroweb.in లేదా యూజర్‌నేమ్',
    ...
    ML: {
      ...
      exampleHint: '<strong>ഡിഫോൾട്ട് മാതൃക:</strong> ഉപയോക്തൃനാമം <code>user@zaroweb.in</code> &bull; പാസ്‌വേഡ് <code>കുറഞ്ഞത് 6 അക്ഷരങ്ങൾ</code> &mdash; ദയവായി മാനുവലായി ടൈപ്പ് ചെയ്യുക.',
      emailLabel: 'ഇമെയിൽ അല്ലെങ്കിൽ ഉപയോക്തൃനാമം',
      emailPlaceholder: 'ഉദാ: user@zaroweb.in അല്ലെങ്കിൽ യൂസർനെയിം',
    ...
    GL: {
      ...
      exampleHint: '<strong>Default Example:</strong> Username <code>user@zaroweb.in</code> &bull; Password <code>min 6 chars</code> &mdash; please manually type your username &amp; password.',
      emailLabel: 'Email or Username',
      emailPlaceholder: 'e.g. user@zaroweb.in or your_username',�ా: user@zaro.agency లేదా యూజర్‌నేమ్',
      emailError: 'దయచేసి సరైన ఇమెయిల్ లేదా యూజర్‌నేమ్ నమోదు చేయండి',
      passwordLabel: 'పాస్‌వర్డ్',
      passwordPlaceholder: 'ఉదా: •••••••• (కనీసం 6 అక్షరాలు)',
      passwordError: 'పాస్‌వర్డ్ కనీసం 6 అక్షరాలు ఉండాలి',
